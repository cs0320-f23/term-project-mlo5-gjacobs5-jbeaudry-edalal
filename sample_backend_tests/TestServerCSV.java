...
import edu.brown.cs.student.main.server.ServerRouteUtility.Announcements;
...
public class TestServerCSV {
  ...
  public void setupBefore() throws DatasourceException {
    ...
    Spark.get("loadcsv", (Route) new Routes());
    Spark.get("viewcsv", (Route) new Announcements());
    Spark.get("searchcsv", (Route) new Stops());
